...
if __name__ == '__main__':
    ...
    print "Mean value using fixed RNN: ", np.mean(tempo_frame_RNN_fixed)
    print "STD value using fixec RNN: ", np.std(tempo_frame_RNN_fixed)
    ...
    print "FIXED Tempo estimation data for RNN: \n", tempo_frame_RNN_fixed
    ...
    plt.figure()
    plt.plot(rawData)
    plt.xlabel("Samples in time", fontsize=FONT_SIZE)
    ...
    plt.ylabel("SpectralFlux Tempo Estimation", fontsize=FONT_SIZE)
    ...
    plt.xlabel("Number of chunks", fontsize=FONT_SIZE)
    plt.ylabel("SuperFlux Tempo Estimation", fontsize=FONT_SIZE)
    ...
    plt.xlabel("Number of chunks", fontsize=FONT_SIZE)
    plt.ylabel("RNN Tempo Estimation", fontsize=FONT_SIZE)
    ...
    plt.xlabel("Number of chunks", fontsize=FONT_SIZE)
    plt.ylabel("Fixed RNN Tempo Estimation", fontsize=FONT_SIZE)
